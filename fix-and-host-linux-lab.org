...
** SSH Server
   ...
   9. Edit =/etc/fstab= and the following line (with proper server
      address)
      #+BEGIN_EXAMPLE
      10.4.15.219:/var/export/nfs4/home /home nfs defaults 0 1
      #+END_EXAMPLE
...
** NFS server (Ubuntu) not working
   ...
   4. Edit =/etc/exports= and add the following lines, replace
      ...
      #+BEGIN_EXAMPLE
      /var/export/nfs4       <ip-address>(rw,sync,no_subtree_check,no_root_squash)
      /var/export/nfs4/home  <ip-address>(rw,sync,no_subtree_check,no_root_squash)
      #+END_EXAMPLE
...
** NFS server (Centos) working
   ...
   8. Write /etc/exports
      #+BEGIN_EXAMPLE
      /var/export/nfs4 10.4.15.0/24(rw,sync,no_subtree_check)
      /var/export/nfs4/home 10.4.15.0/24(rw,sync,no_subtree_check)
      #+END_EXAMPLE
   9. Export them
      #+BEGIN_EXAMPLE
      exportfs -rav
...
** Host
   - refer: https://wiki.archlinux.org/index.php/kernel_modules
